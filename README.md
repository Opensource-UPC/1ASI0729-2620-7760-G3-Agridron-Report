...
The current state of crop protection has focused mainly on small and medium farmers and agricultural cooperatives who rely on manual or tractor-based pesticide application methods and lack real-time data about their field operations.

</p>

<p align="justify">

What existing products/services fail to address is an integrated platform that allows farmers and technical staff to plan, execute, and monitor drone-based spraying missions and consult operational reports from a single place.

</p>

<p align="justify">

Our product/service will address this gap by providing an integrated platform for planning, autonomous spraying, and real-time monitoring of drone-based crop protection operations.

</p>

<p align="justify">

Our initial focus will be small and medium farmers (PyMAs) and the agricultural technical staff responsible for planning and supervising crop protection operations.

</p>

<p align="justify">

We'll know we are successful when we see farmers reducing spraying time and cost, and adopting the platform's monitoring and reporting features across consecutive growing seasons.
...
<ul>
  <li><strong>Valor:</strong> los agricultores están dispuestos a pagar por un servicio de fumigación con drones que reduzca costos operativos y mejore el rendimiento de sus cultivos.</li>
  <li><strong>Mercado:</strong> existe una demanda de herramientas tecnológicas accesibles para pequeños y medianos productores.</li>
  <li><strong>Crecimiento:</strong> las cooperativas agrícolas recomendarán el servicio a otros productores si se demuestra un retorno de inversión (ROI) claro.</li>
  <li><strong>Sostenibilidad:</strong> el ahorro en insumos y mano de obra ayudará a compensar el costo del servicio.</li>
</ul>
